                    ...
                    <tr>
                        <td class="content-padding" style="padding: 30px 24px;">
                            ...
                            <div style="margin-bottom: 16px;">
                                <span style="display: inline-block; background-color: #fef3c7; color: #92400e; font-size: 12px; font-weight: 600; padding: 4px 12px; border-radius: 9999px; text-transform: uppercase; letter-spacing: 0.5px;">Action Required</span>
                            </div>
                            ...
                            <!-- Case Details Box -->
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation" style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-left: 4px solid #f59e0b; border-radius: 6px; margin-bottom: 24px;">
                                <tr>
                                    <td style="padding: 16px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                            <tr>
                                                <td class="stack-col detail-label" valign="top" style="font-size: 14px; font-weight: 600; color: #334155; width: 140px; padding: 4px 0;">Project Title:</td>
                                            ...
                                            <tr>
                                                <td class="stack-col detail-label" valign="top" style="font-size: 14px; font-weight: 600; color: #334155; width: 140px; padding: 4px 0;">Case Reference:</td>
                                            ...
                                            <tr>
                                                <td class="stack-col detail-label" valign="top" style="font-size: 14px; font-weight: 600; color: #334155; width: 140px; padding: 4px 0;">Review Stage:</td>
                                                <td class="stack-col detail-value" valign="top" style="font-size: 14px; color: #0f172a; word-break: break-word; padding: 4px 0;">{{ $stageName }}</td>
                                            </tr>
                                            <tr>
                                                <td class="stack-col detail-label" valign="top" style="font-size: 14px; font-weight: 600; color: #334155; width: 140px; padding: 4px 0;">District:</td>
                                                <td class="stack-col detail-value" valign="top" style="font-size: 14px; color: #0f172a; word-break: break-word; padding: 4px 0;">{{ $project->district ?? 'N/A' }}</td>
                                            </tr>
                                            <tr>
                                                <td class="stack-col detail-label" valign="top" style="font-size: 14px; font-weight: 600; color: #334155; width: 140px; padding: 4px 0;">Divisional Secretariat:</td>
                                                <td class="stack-col detail-value" valign="top" style="font-size: 14px; color: #0f172a; word-break: break-word; padding: 4px 0;">{{ $project->divisional_sec ?? 'N/A' }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation" style="margin: 24px 0 10px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ $actionUrl }}" class="btn-mobile" target="_blank" style="display: inline-block; background-color: #2563eb; color: #ffffff; text-decoration: none; padding: 12px 28px; border-radius: 6px; font-weight: 600; font-size: 14px; text-align: center;">Review Case & Approve</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
