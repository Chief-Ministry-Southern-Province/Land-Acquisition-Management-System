...
import {
  ...
  queryCase,
  rejectCase,
} from '@/services/aoApprovalService';
  ...
  return (
    <div className="relative space-y-6">
      ...
      <DataTable
        ...
        pageSize={10}
        loading={loading}
        loadingMessage="Loading Administrative Officer pending approvals..."
      />
...
AOApprovals.layout = (page: React.ReactNode) => <MainLayout>{page}</MainLayout>;
