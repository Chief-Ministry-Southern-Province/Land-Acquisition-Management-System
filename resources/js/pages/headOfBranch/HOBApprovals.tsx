...
export default function HOBApprovals() {
  ...
  const stats = [
    ...
    {
      title: t('kpi_pending_hob_action', 'Pending HOB Action'),
    ...
    <div className="relative space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          {t(
            'hob_clearance_subtitle',
            'Review, query, or approve land acquisition projects submitted for Head of Branch verification.',
          )}
        </p>
      </div>
        ...
        <div className="flex gap-1">
          {[
            ...
            },
            {
              id: 'pending',
              label: t(
                'tab_pending_hob_action',
                'Pending HOB Action (:count)',
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-card border-border relative max-h-[90vh] w-full max-w-md space-y-4 rounded-xl border p-6 shadow-2xl">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              {t(
                'confirm_hob_approval_desc',
                'Are you sure you want to approve the project :id (:title)? This will forward it to the Administrative Officer (AO) for legal notice clearance.',
              )
                .replace(':id', actionTarget.displayId)
            ...
            <div className="border-border flex items-center justify-between border-b px-6 py-4">
              <div>
                <span className="text-primary text-xs font-bold uppercase tracking-wider">
                  {t(
                    'project_acquisition_verification',
