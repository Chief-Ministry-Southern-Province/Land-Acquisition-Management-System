...
import {
  ...
  approveCase,
  rejectCase,
} from '@/services/secApprovalService';
  ...
  return (
    <div className="relative space-y-6">
      ...
      <DataTable
        ...
        pageSize={10}
        loading={loading}
        loadingMessage="Loading secretary pending approvals..."
      />
...
SecretaryApprovals.layout = (page: React.ReactNode) => (
