...
function LoginScreen() {
    ...
    return (
        <div className="from-primary to-primary/80 flex min-h-screen items-center justify-center bg-linear-to-br">
                ...
                <div className="bg-card rounded-lg p-8 shadow-xl">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="bg-input-background border-border focus:ring-primary w-full rounded-lg border px-4 py-2 focus:ring-2 focus:outline-none"
                    ...
                    <div className="bg-muted/50 mt-6 rounded-lg p-4">
                        <p className="text-muted-foreground text-center text-xs">
                            <strong>Security Notice:</strong> This is a
