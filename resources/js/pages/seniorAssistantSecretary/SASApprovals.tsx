...
export default function SASApprovals() {
  ...
  return (
    <div className="relative space-y-6">
      ...
      {/* Header */}
      <div>
        <h1>Senior Assistant Secretary Clearance</h1>
        <p className="text-muted-foreground mt-1">
          Review or approve land acquisition projects submitted for Senior
          Assistant Secretary final financial clearance.
        </p>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="bg-card border-border relative max-h-[90vh] w-full max-w-md space-y-4 rounded-xl border p-6 shadow-2xl">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              This will grant financial clearance. If the total valuation
              exceeds 20M LKR, it will be escalated to the Secretary for final
              approval.
            </p>
